    ...
    return InkWell(
      ...
      onTap: () {
        NavigateRoute.toDetailProduct(
            context: context, productId: wishlist.productId);
      },
      child: Container(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            onPressed: wishlist.product!.stock > 0
                                ...
                                : null,
                            child: wishlist.product!.stock > 0
                                ? const Text('Sepete ekle')
                                : const Text('Stok bulunamadı'),
                          ),
                        ],
                      );
                    },
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          ' '
                          '(${wishlist.product!.totalReviews} Yorumlar)',
                        ),
                      ],
                    ),
                ],
