      ...
      child: Row(
        ...
        children: [
          CircleAvatar(
            ...
            backgroundImage: customer.photoProfileUrl.isNotEmpty
                ? NetworkImage(customer.photoProfileUrl)
                : null,
                ...
                Row(
                  ...
                  children: [
                    customer.banStatus
                        ? OutlinedButton(
                            onPressed: () {
                              context.read<AccountProvider>().ban(
                                  accountId: customer.accountId, ban: false);
                            },
                            child: const Text('Müşteri engelini kaldır'),
                          )
                        : ElevatedButton(
                            onPressed: () {
                              context.read<AccountProvider>().ban(
                                  accountId: customer.accountId, ban: true);
                            },
                            child: const Text('Müşteriyi engelle'),
                          ),
                  ],
                ),
              ],
