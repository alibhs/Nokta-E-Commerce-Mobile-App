...
enum OrderByEnum {
  ...
  @override
  String toString() {
    if (this == OrderByEnum.newest) {
      return "En Yeni";
    } else if (this == OrderByEnum.oldest) {
      return "En Eski";
    } else if (this == OrderByEnum.cheapest) {
      return "En Ucuz";
    } else if (this == OrderByEnum.mostExpensive) {
      return "En Pahalı";
    } else if (this == OrderByEnum.leastStar) {
      return "En Az Popüler";
    } else {
      return "En Popüler";
    }
  }
